...
lines = ["You’re not failing.", "You’re carrying", "all of it."]
y = 470
for ln in lines:
...
body = ("One 45-minute conversation. A personalized report "
        "in 48 hours that finally sees the invisible work.")
...
draw_text("$75  ·  ONE CALL  ·  BOOKING LINK IN COMMENTS", CX, fy+52, SANS, 23, ROSE, tracking=4)

surf.write_to_png("/sessions/sharp-gracious-euler/mnt/outputs/YFB_FB_ParentGroup.png")
print("done")
